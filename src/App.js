...
export default class App extends Component {
  ...
  handleShow = (artist, index) => {
    ...
    axios
      .get(
        `https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=${flickrApiKey}&tags=${artist}&per_page=3&format=json&nojsoncallback=1`,
      )
      .then(response => {
